import pandas as pd
from get_server_data import raw_db_filename, get_table_for_variable_code
...
rain_df = get_table_for_variable_code('rainfall').sort_index()
...
gw_df = get_table_for_variable_code('groundwater').sort_index()
...
tide_df = get_table_for_variable_code('tide').sort_index()
...
wind_dir_df = get_table_for_variable_code('wind_dir').sort_index()
wind_vel_df = get_table_for_variable_code('wind_vel').sort_index()
wind_daily = get_table_for_variable_code(9).sort_index()
wind_daily_dir = get_table_for_variable_code(13).sort_index()
